      ...
      <div className="info">
        ...
        <div className="text_container">
          <p className="text">
            ...
            space, TebboToken welcomes you.
          </p>
          <p className="text-sml">
            TebboToken isn't just a digital currency; it's a project born out of
            a desire to learn and share knowledge.
          </p>
          <p className="text-sml">
            It serves as an example of what can be achieved with dedication and
            a passion for blockchain technology.
          </p>
          <p className="text-sml">
            Through TebboToken, the developer invites others to explore the
            world of cryptocurrencies in a straightforward and uncomplicated
            manner.
          </p>
        </div>
